        ...
        class ReduxFramework_extension_customizer {
            ...
            public function __construct( $parent ) {
                ...
                if ( empty( $this->_extension_dir ) ) {
                    $this->_extension_dir = trailingslashit( str_replace( '\\', '/', get_template_directory() . '/inc/integration/ReduxCore/inc/extensions/customizer' ) );
            ...
            public function _register_customizer_controls( $wp_customize ) {
                ...
                if ( ! class_exists( 'Redux_Customizer_Section' ) ) {
                    include_once get_template_directory() . '/inc/integration/ReduxCore/inc/extensions/customizer/inc/customizer_section.php';
                    if ( method_exists( $wp_customize, 'register_section_type' ) ) {
                        $wp_customize->register_section_type( 'Redux_Customizer_Section' );
                    }
                }
                if ( ! class_exists( 'Redux_Customizer_Panel' ) ) {
                    include_once get_template_directory() . '/inc/integration/ReduxCore/inc/extensions/customizer/inc/customizer_panel.php';
                ...
                if ( ! class_exists( 'Redux_Customizer_Control' ) ) {
                    include_once get_template_directory() . '/inc/integration/ReduxCore/inc/extensions/customizer/inc/customizer_control.php';
                }

                include_once get_template_directory() . '/inc/integration/ReduxCore/inc/extensions/customizer/inc/customizer_fields.php';
                include_once get_template_directory() . '/inc/integration/ReduxCore/inc/extensions/customizer/inc/customizer_devs.php';
...
echo '1';
            ...
            public function _enqueue_previewer() {
                ...
                $localize = array(
                    'save_pending'   => esc_html__( 'You have changes that are not saved. Would you like to save them now?', 'food-lounge' ),
                    'reset_confirm'  => esc_html__( 'Are you sure? Resetting will lose all custom values.', 'food-lounge' ),
                    'preset_confirm' => esc_html__( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'food-lounge' ),
