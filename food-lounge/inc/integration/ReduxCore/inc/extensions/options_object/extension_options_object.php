        ...
        class ReduxFramework_Extension_options_object {
            ...
            public function add_section() {
                $this->parent->sections[] = array(
                    'id' => 'options-object',
                    'title' => esc_html__( 'Options Object', 'food-lounge' ),
                    'heading' => '',
            ...
            public function overload_field_path( $field ) {
                return get_template_directory() . '/inc/integration/ReduxCore/inc/extensions/options_object' . '/' . $this->field_name . '/field_' . $this->field_name . '.php';
            }
        } // class
    } // if
