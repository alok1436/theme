        ...
        class ReduxFramework_extension_import_export {
            ...
            public function add_section() {
                $this->parent->sections[] = array(
                    'id'         => 'import/export',
                    'title'      => esc_html__( 'Import / Export', 'food-lounge' ),
                    'heading'    => '',
                    'icon'       => 'el el-refresh',
                    'customizer' => false,
                    'fields'     => array(
            ...
            public function overload_field_path( $field ) {
                return get_template_directory() . '/inc/integration/ReduxCore/inc/extensions/import_export' . '/' . $this->field_name . '/field_' . $this->field_name . '.php';
            }
