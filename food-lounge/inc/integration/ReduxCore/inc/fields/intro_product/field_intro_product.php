    ...
    class ReduxFramework_intro_product
    {
        ...
        public function render()
        {
            ...
            <div class="intro-product">
                <div class="food-logo"><img alt="Food Lounge" src=""></div>
                <div class="food-tools">
                    <ul>
                        <li><a href="#"><i class="dashicons dashicons-album"></i><span>V<?php echo esc_attr($theme->get('Version')); ?></span></a></li>
                        <li><a href="<?php echo esc_url('#');?>"><i class="dashicons dashicons-groups"></i><span><?php esc_html_e("Forum Support", 'food-lounge'); ?></span></a></li>
                        <li><a href="<?php echo esc_url('#');?>"><i class="dashicons dashicons-products"></i><span><?php esc_html_e("Food Lounge", 'food-lounge'); ?></span></a></li>
                        <li><a href="#"><i class="dashicons dashicons-email"></i><span><?php esc_html_e("Contact Now", 'food-lounge'); ?></span></a></li>
                    </ul>
                </div>
