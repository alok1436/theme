...
<header id="food-header-2" class="site-header">
...
<div id="food-header" class="food-main-header food-header-2 <?php if ( !$smof_data['menu_sticky'] && empty($food_meta->_food_enable_header_fixed) ) {
    echo 'no-sticky';
} ?> <?php if ($smof_data['menu_sticky_tablets']) {
    echo 'sticky-tablets';
} ?> <?php if ($smof_data['menu_sticky_mobile']) {
    echo 'sticky-mobile';
} ?> <?php if (!empty($food_meta->_food_enable_header_fixed)) {
    echo 'header-fixed-page';
} ?> <?php if (!empty($food_meta->_food_enable_header_menu)) {
	...
	<div class="container">
		...
		<nav id="food-header-navigation-fixed" class="navbar">
			...
			<div class="navbar-header">
			  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#food-header-navbar-2" aria-expanded="false">
			...
			<div class="collapse navbar-collapse" id="food-header-navbar-2">
						<?php
							$attr = array(
